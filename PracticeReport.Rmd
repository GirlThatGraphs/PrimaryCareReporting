...
MM_Finance <- read_excel("O:/BSS/BI/Intelligence Services/BSSW/Somerset/Reports/Primary_Care_Report/Data/MM scorecard March 2021 final.xlsx",
                         ...
                         range = "A1:Y66")
#
MM_Green <- read_excel("Data/MM scorecard 2022-23 July final.xlsx",
...
#
GMS_Contracts <-
  read_excel("//somerset.xswhealth.nhs.uk/ccg/Directorate/Clinical Commissioning Development/Comm & PC Services/PRIMARY CARE/1/Contract Processes/Contract Variations/1. Contract Variation Tracker.xlsm",
             sheet = "GMS",
             skip = 1)
...
LD_Health_CheckIn <- read_excel("Data/LD health Check Scheme Practice Payment 22-23.xlsm",
                                range = "A3:AO67")
...
The table below gives current in year 2022/23 practice and Somerset achievement within the ICBs key clinical priority areas as at `r as.Date(as.character(QOFDate), "%Y%m%d")`. Also shown are the 2019/20 & 2022/23 achievements at practice, Somerset and National level. Where the information is blank, this is due to the
...
QOF %>%
  ...
  tab_spanner(label = "1920 Achievement",
  ...
  cols_label(`2223Achievement` = ("Practice"),
             ...
             `1920Achievement` = ("Practice"),
             `1920SomAchievement` = ("Somerset"),
             `1920 National Achievement` = ("National"),
...
As at `r LD_Health_CheckDate` 2022/23 the practice has currently
